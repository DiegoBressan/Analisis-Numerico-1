...
namespace Formulario
{
    ...
    {
        public MetodoReglaFalsa(MetodoCerrado metodoCerrado, Datos datos)
        {
            InitializeComponent();
            label10.Visible = false;
            label11.Visible = false;
            label12.Visible = false;
            CompletarDatosMetodo(metodoCerrado, datos);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (this.textBox1.Text != "" && this.textBox2.Text != "" && this.textBox3.Text != "" && this.textBox4.Text != "" && this.textBox5.Text != "")
            {
                ...
                {
                    NuevoResultado = formularioprincipal.ObtenerRaizReglaFalsa(datos, metodo);
